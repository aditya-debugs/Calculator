...
function addValue(value) {
  if (value === ".") {
    // To Find the index of the last operator in the expression
    const lastOperatorIndex = expression.search(/[+\-*/]/);
    // To Find the index of the last decimal in the expression
    const lastDecimalIndex = expression.lastIndexOf(".");
    // To Find the index of the last number in the expression
    ...
    // To Check if this is the first decimal in the current number or if the expression is empty
    if (
